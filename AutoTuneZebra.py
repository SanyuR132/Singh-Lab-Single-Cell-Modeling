...
def tunePRESCIENT():
    ...
    def create_train_parser(
        ...
        parser.add_argument('-i', '--data_path', default="/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/zebrafish/pt_data/before_day{}_data.pt".format(day),
                            help="Input PRESCIENT data torch file.")
    ...
    day = "6_0" if args.d is None else args.d
    train_epochs = 100
    n_trials = args.n
    print("*" * 70)
    ...
    original_validate_data = readMtx("/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/zebrafish/gene_exp_mat_time_{}_100k_sf_1e04_zeb_exp.mtx".format(day))
