...
normalAugmentation <- function() {
  ...
  write.csv(filter, './Prediction/ZINBWaVE/mouse_cell-ZINBWaVE-filter.csv')
  ...
  saveRDS(zinb_model, file = './Prediction/ZINBWaVE/mouse_cell-ZINBWaVE_model.rds')
  writeMM(as(predictions, "sparseMatrix"), file = './Prediction/ZINBWaVE/mouse_cell-ZINBWaVE_esimation.mtx')
