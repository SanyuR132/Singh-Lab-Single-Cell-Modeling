...
normalAugmentation <- function() {
  # Read data
  filename <- "./Data/splat_simulation/wo_preprocess/training_all.mtx"
  ...
  write.csv(filter, './Prediction/ZINBWaVE/splat_simulation-ZINBWaVE-filter.csv')
  # fitting ZINB-Wave model
  zinb_model <- modelFitting(filtered_data)
  print("Finished fitting...")
  # simulate with ZINB-WaVe
  test_filename <- "./Data/splat_simulation/wo_preprocess/testing_all.mtx"
  ...
  saveRDS(zinb_model, file = './Prediction/ZINBWaVE/splat_simulation-ZINBWaVE_model.rds')
  writeMM(as(predictions, "sparseMatrix"), file = './Prediction/ZINBWaVE/splat_simulation-ZINBWaVE_esimation.mtx')
