...
normalAugmentation <- function() {
  ...
  saveRDS(model, file = './Prediction/scDesign2/splat_simulation-scDesign2_copula_model.rds')
  writeMM(as(predictions, "sparseMatrix"), file = './Prediction/scDesign2/splat_simulation-scDesign2_estimation.mtx')
