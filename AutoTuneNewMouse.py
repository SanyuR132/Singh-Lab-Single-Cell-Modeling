...
def tunePRESCIENT():
    ...
    def create_train_parser(
        ...
        parser.add_argument('-i', '--data_path', default="/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/new_mouse_cell/pt_data/before_day{}_data.pt".format(day),
                            help="Input PRESCIENT data torch file.")
    ...
    day = "10" if args.d is None else args.d
    train_epochs = 100
    n_trials = args.n
    print("*" * 70)
    ...
    original_validate_data = readMtx("/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/new_mouse_cell/gene_exp_mat_time_{}_5_rc.mtx".format(day)).T
