...
from Models.scvae.analyses.figures.histograms import (
    plot_histogram, plot_cutoff_count_histogram,
    plot_class_histogram, plot_probabilities
)
from Models.scvae.analyses.figures.learning_curves import (
...
from Models.scvae.analyses.figures.matrices import (
    plot_matrix, plot_correlation_matrix, plot_heat_map)
from Models.scvae.analyses.figures.saving import save_figure
from Models.scvae.analyses.figures.scatter import (
    plot_values, plot_variable_correlations, plot_variable_label_correlations
)
from Models.scvae.analyses.figures.series import plot_series, plot_profile_comparison
from Models.scvae.analyses.figures.style import reset_plot_look
