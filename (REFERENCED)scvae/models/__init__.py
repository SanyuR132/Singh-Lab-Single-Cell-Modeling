...
from Models.scvae.utilities import suppress_stdout
with suppress_stdout():
    importlib.import_module("tensorflow.contrib.layers")

from Models.scvae.models.variational_autoencoder import (
    VariationalAutoencoder)  # noqa: E402
from Models.scvae.models.gaussian_mixture_variational_autoencoder import (
