...
def normalAugmentExp():
    ...
    config = {
        ...
        "test_preds_filename": "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/new_baseline_results/scvae/new_mouse_cell/new_mouse_cell-scVAE_test_preds.mtx",
    }
