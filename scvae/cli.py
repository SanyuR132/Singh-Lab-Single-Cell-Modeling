...
from models import VariationalAutoencoder, GaussianMixtureVariationalAutoencoder
from defaults import defaults
from data.utilities import build_directory_path, indices_for_evaluation_subset
from data import DataSet
from analyses.prediction import PredictionSpecifications, predict_labels
import analyses
...
def train(
    ...
    **keyword_arguments,
    ...
    # editing to pass keyword argument (which include preprocessed values and labels)
    data_set = DataSet(
        data_set_file_or_name,
        data_format=data_format,
        directory=data_directory,
    ...
    # checking if validation set is given
    print("validation set given?:", validation_set is not None)
    print("training set shape:", training_set.values.shape)
...
def evaluate(
    ...
    **keyword_arguments,
    ...
    if models_directory is None:
        models_directory = defaults["models"]["directory"]
    evaluation_set_kind = "full"  # TODO: check this part
    ...
    # [Jiaqi] Specify model version
    # model_versions = ["end_of_training"]
    print(title("Data"))
    ...
    # [Jiaqi] Pass model from parameters
    # model = _setup_model(
    #     data_set=evaluation_set,
    #     model_type=model_type,
    #     latent_size=latent_size,
    ...
    return (
        sample_reconstruction_set.values,
        transformed_evaluation_set.values.toarray(),
...
def _setup_model(
    ...
    if model_type is None:
        model_type = defaults["models"]["type"]
