...
from utilities import format_duration, normalise_string
...
class DataSet:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if data_format == "infer":
            ...
            print(f"before commented code in data/data_set.py")
            # ==================================
            # [Jiaqi] Removed for loading dataset
    ...
    def update(
        ...
        if preprocessed_values is not None:
            ...
            print("self.preprocessed_values is defined")
        ...
        for data_subset in split_data_dictionary:
            ...
            for data_subset_key in split_data_dictionary[data_subset]:
                if "values" in data_subset_key:
                    ...
                    if values is not None:
                        split_data_dictionary[data_subset][
                            data_subset_key
