...
def normalAugmentExp():
    # parameters configuration
    config = {
        "config_file": "./ZebrafishData_exp.json",
        "need_save": True,
        # ------------------------------------------
        # "prediction_save_path": "../../Prediction/scVAE/mouse_cell-scVAE_estimation.npz",
        "estimation_filename": "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/Baseline_Results/zebrafish/zebrafish-scVAE_estimation.mtx",
        "train_data_filename": "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/Baseline_Results/zebrafish/zebrafish-scVAE_train_data.mtx",
        "test_preds_filename": "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/Baseline_Results/zebrafish/zebrafish-scVAE_test_preds.mtx",
        "test_labels_filename": "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/Baseline_Results/zebrafish/zebrafish-scVAE_test_labels.mtx"
    }
