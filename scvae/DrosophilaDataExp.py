...
data_path = (
    "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/Data/drosophila/"
    + "upto_tp"
    + str(args.ttp)
)
...
if args.lhsdt:
    hyperparameters_file_path = os.path.join(
        "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/tuning_results/scVAE/drosophila",
...
save_dir = (
    "/users/srajakum/scratch/Structure_VAE_scRNA_Simulator/baseline_results/scVAE/drosophila/"
    + date_and_time
    + "_ttp_"
    + str(args.ttp)
)
