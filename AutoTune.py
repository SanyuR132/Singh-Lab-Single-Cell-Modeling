...
def tunePRESCIENT():
    ...
    def create_train_parser(
        ...
        parser.add_argument('-i', '--data_path', default="/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/WOT/pt_data/before_day{}_data.pt".format(day),
                            help="Input PRESCIENT data torch file.")
        # parser.add_argument('-i', '--data_path',
        #                     default="../Data/WOT/pt_data/before_day{}_data.pt".format(
        #                         day),
        #                     help="Input PRESCIENT data torch file.")
    ...
    def create_simulate_parser(num_cells=None, k_dim=None, tau=None, lr=None, clip=None, sd=None, batch=None, layers=None):
        parser = argparse.ArgumentParser()
        # parser.add_argument("-i", "--data_path", default="../Data/mouse_cell/pt_data/before_day11_data.pt", required=False,
    ...
    day = "1.0" if args.d is None else args.d
    train_epochs = 100
    n_trials = args.n
    print("*" * 70)
    ...
    # original_validate_data = readMtx("../Data/mouse_cell/wo_preprocess/gene_cnt_mat_time_{}_5.mtx".format(day))
    original_validate_data = readMtx("/gpfs/data/rsingh47/jzhan322/Structure_VAE/Data/WOT/pt_data/day{}_data.mtx".format(day)).T
    # original_validate_data = readMtx("../Data/WOT/pt_data/day1.0_data.mtx".format(day)).T
