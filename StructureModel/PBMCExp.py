...
def normalAugmentExp():
    ...
    config = {
        ...
        "learning_rate" : 1e-4,
        # # ------------------------------------------
        # "train_data": readH5ad("../../Data/PBMC/w_preprocess/training_data.h5ad"),
        # "validate_data": readH5ad("../../Data/PBMC/w_preprocess/validate_data.h5ad"),
        # "test_data": readH5ad("../../Data/PBMC/w_preprocess/testing_data.h5ad"),
        # # ------------------------------------------
        # "model_save_path" : "../../Prediction/StructureVAE/PBMC-VAE_model.pt",
        # "prediction_save_path": "../../Prediction/StructureVAE/PBMC-VAE_estimation.npy",
        # ------------------------------------------
        "train_data": readH5ad("../../Data/PBMC/w_preprocess/training_data.h5ad"),
        "validate_data": readH5ad("../../Data/PBMC/w_preprocess/validate_data.h5ad"),
        "test_data": readH5ad("../../Data/PBMC/w_preprocess/testing_data.h5ad"),
