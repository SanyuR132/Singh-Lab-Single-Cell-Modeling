...
def normalAugmentExp():
    ...
    config = {
        ...
        # ------------------------------------------
        "model_save_path" : "/gpfs/data/rsingh47/jzhan322/Prediction/mouse_cell-VAE_model.pt",
        "prediction_save_path": "/gpfs/data/rsingh47/jzhan322/Prediction/mouse_cell-VAE_estimation.npy",
    }
    config = addDefaultArg(config)
